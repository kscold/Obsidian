...
- 하지만 [[객체(Object)]]는 참조용 [[Spring/SQL/필드(Field)|필드(Field)]]가 있는 [[객체(Object)]]만이 다른 [[객체(Object)]]를 참조하는 것이 가능하다. 
- 따라서 두 [[객체(Object)]] 사이에 하나의 참조용 필드만을 가지고 참고하게 되면 단방향 관계이고, 두 [[객체(Object)]] 모두가 참조용 [[Spring/SQL/필드(Field)|필드(Field)]]를 갖고 참조하면 양방향 관계가 된다.
