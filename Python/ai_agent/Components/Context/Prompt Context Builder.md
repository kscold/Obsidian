...
Prompt Context Builder는 LLM 호출에 필요한 사실, 제약, 현재 상태, 출력 형식을 하나의 입력 컨텍스트로 조립하는 레이어이다. [[Context Engineering]] 원칙을 실제 호출 단위로 적용하는 구성 요소라고 볼 수 있다.
...
관련: [[Context Engineering]], [[Prompt Engineering]], [[Structured Output]], [[Data-aware Prompting]]
